...
<div class="relative bg-gradient-to-br from-green-900 via-primary to-emerald-800 overflow-hidden pt-32 pb-32">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
        <span class="inline-flex items-center gap-2 py-1.5 px-5 rounded-full bg-white/10 text-green-50 text-xs font-bold tracking-widest uppercase mb-6 backdrop-blur-md border border-white/20 shadow-lg">
            <svg class="w-4 h-4 text-green-300" fill="currentColor" viewBox="0 0 24 24"><path d="M13 2L3 14h9l-1 8 10-12h-9l1-8z"></path></svg>
            Statistik & Informasi
        </span>
        <h1 class="text-4xl font-extrabold text-white tracking-tight sm:text-5xl lg:text-6xl mb-6 drop-shadow-2xl">Data Terbuka Desa</h1>
        <p class="text-xl text-green-100/80 max-w-2xl mx-auto drop-shadow-md font-medium">Transparansi data kependudukan, pendidikan, dan pekerjaan masyarakat Desa Cigalontang secara aktual.</p>
    </div>
    
    <!-- Wave curve at the bottom -->
    <div class="absolute bottom-0 left-0 right-0">
        <svg class="w-full h-12 md:h-24 text-gray-50 fill-current" viewBox="0 0 1440 74" xmlns="http://www.w3.org/2000/svg">
            <path d="M0,32L48,37.3C96,43,192,53,288,58.7C384,64,480,64,576,58.7C672,53,768,43,864,42.7C960,43,1056,53,1152,58.7C1248,64,1344,64,1392,64L1440,64L1440,74L1392,74C1344,74,1248,74,1152,74C1056,74,960,74,864,74C768,74,672,74,576,74C480,74,384,74,288,74C192,74,96,74,48,74L0,74Z"></path>
        </svg>
    </div>
</div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                <div class="space-y-6">
                    ...
                    <div class="group">
                        <div class="flex justify-between text-sm font-bold mb-2">
                            <span class="text-gray-600 group-hover:text-green-600 transition-colors">SD / Sederajat</span>
                            <span class="text-gray-900">1.250 Jiwa</span>
                        </div>
                        <div class="w-full bg-gray-100 rounded-full h-3 overflow-hidden">
                            <div class="bg-gradient-to-r from-green-400 to-green-600 h-3 rounded-full relative" style="width: 45%">
                    ...
                    <div class="group">
                        <div class="flex justify-between text-sm font-bold mb-2">
                            <span class="text-gray-600 group-hover:text-green-600 transition-colors">SMP / Sederajat</span>
                            <span class="text-gray-900">850 Jiwa</span>
                        </div>
                        <div class="w-full bg-gray-100 rounded-full h-3 overflow-hidden">
                            <div class="bg-gradient-to-r from-teal-400 to-teal-600 h-3 rounded-full relative" style="width: 35%">
                                <div class="absolute top-0 right-0 bottom-0 left-0 bg-white/20 animate-pulse" style="animation-delay: 200ms"></div>
                            </div>
                        </div>
                    </div>
                    <!-- Bar Item -->
                    <div class="group">
                        <div class="flex justify-between text-sm font-bold mb-2">
                            <span class="text-gray-600 group-hover:text-green-600 transition-colors">SMA / Sederajat</span>
                            <span class="text-gray-900">450 Jiwa</span>
                        </div>
                        <div class="w-full bg-gray-100 rounded-full h-3 overflow-hidden">
                            <div class="bg-gradient-to-r from-emerald-400 to-emerald-600 h-3 rounded-full relative" style="width: 20%">
                                <div class="absolute top-0 right-0 bottom-0 left-0 bg-white/20 animate-pulse" style="animation-delay: 400ms"></div>
                            </div>
                        </div>
                    </div>
                    <!-- Bar Item -->
                    <div class="group">
                        <div class="flex justify-between text-sm font-bold mb-2">
                            <span class="text-gray-600 group-hover:text-green-600 transition-colors">Diploma / Sarjana</span>
                            <span class="text-gray-900">120 Jiwa</span>
                        </div>
                        <div class="w-full bg-gray-100 rounded-full h-3 overflow-hidden">
                            <div class="bg-gradient-to-r from-cyan-400 to-cyan-600 h-3 rounded-full relative" style="width: 8%">
                                <div class="absolute top-0 right-0 bottom-0 left-0 bg-white/20 animate-pulse" style="animation-delay: 600ms"></div>
                            </div>
                        </div>
                    </div>
                    <!-- Bar Item -->
                    <div class="group">
                        <div class="flex justify-between text-sm font-bold mb-2">
                            <span class="text-gray-600 group-hover:text-gray-800 transition-colors">Belum / Tidak Sekolah</span>
                            <span class="text-gray-900">717 Jiwa</span>
                        </div>
                        <div class="w-full bg-gray-100 rounded-full h-3 overflow-hidden">
                            <div class="bg-gray-300 h-3 rounded-full" style="width: 25%"></div>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-3xl shadow-sm border border-gray-100 p-8 hover:shadow-lg transition-shadow duration-300">
                ...
                <div class="grid grid-cols-2 gap-4">
                    <!-- Card Item -->
                    <div class="bg-gray-50/50 rounded-2xl p-5 border border-gray-100 hover:border-green-200 hover:bg-green-50/30 hover:shadow-sm transition-all group">
                        <h4 class="text-[11px] font-bold text-gray-500 uppercase tracking-widest group-hover:text-green-600 mb-2">Petani / Pekebun</h4>
                        <p class="text-3xl font-black text-gray-900">1.420 <span class="text-xs font-bold text-gray-400">Jiwa</span></p>
                    </div>
                    <!-- Card Item -->
                    <div class="bg-gray-50/50 rounded-2xl p-5 border border-gray-100 hover:border-teal-200 hover:bg-teal-50/30 hover:shadow-sm transition-all group">
                        <h4 class="text-[11px] font-bold text-gray-500 uppercase tracking-widest group-hover:text-teal-600 mb-2">Wiraswasta</h4>
                        <p class="text-3xl font-black text-gray-900">450 <span class="text-xs font-bold text-gray-400">Jiwa</span></p>
                    </div>
                    <!-- Card Item -->
                    <div class="bg-gray-50/50 rounded-2xl p-5 border border-gray-100 hover:border-emerald-200 hover:bg-emerald-50/30 hover:shadow-sm transition-all group">
                        <h4 class="text-[11px] font-bold text-gray-500 uppercase tracking-widest group-hover:text-emerald-600 mb-2">Karyawan Swasta</h4>
                        <p class="text-3xl font-black text-gray-900">320 <span class="text-xs font-bold text-gray-400">Jiwa</span></p>
                    </div>
                    <!-- Card Item -->
                    <div class="bg-gray-50/50 rounded-2xl p-5 border border-gray-100 hover:border-cyan-200 hover:bg-cyan-50/30 hover:shadow-sm transition-all group">
                        <h4 class="text-[11px] font-bold text-gray-500 uppercase tracking-widest group-hover:text-cyan-600 mb-2">PNS / TNI / POLRI</h4>
                        <p class="text-3xl font-black text-gray-900">85 <span class="text-xs font-bold text-gray-400">Jiwa</span></p>
                    </div>
                    <!-- Card Item -->
                    <div class="col-span-2 bg-gray-50/50 rounded-2xl p-5 border border-gray-100 hover:border-gray-300 hover:bg-white hover:shadow-sm transition-all group flex justify-between items-center mt-2">
                        <h4 class="text-xs font-bold text-gray-500 uppercase tracking-widest group-hover:text-gray-800">Lainnya / Belum Bekerja</h4>
                        <p class="text-3xl font-black text-gray-900">1.112 <span class="text-sm font-bold text-gray-400">Jiwa</span></p>
                    </div>
                </div>
            </div>
