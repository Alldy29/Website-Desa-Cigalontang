<x-app-layout>
    @section('title', 'Tambah Mitra UMKM')
    @section('header_title', 'Tambah Mitra UMKM')

    <div class="max-w-2xl bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
        <form action="{{ route('admin.umkm.mitra.store') }}" method="POST" class="space-y-6">
            @csrf
            ...
            <div>
                ...
                <textarea name="alamat" id="alamat" rows="3" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-xl focus:ring-primary focus:border-primary block w-full p-2.5" placeholder="Contoh: Dusun Sukamaju RT 01">{{ old('alamat') }}</textarea>
