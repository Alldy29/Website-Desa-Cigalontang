<x-app-layout>
    ...
    <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
        <div class="flex justify-between items-center mb-6">
            ...
            <a href="{{ route('admin.users.create') }}" class="bg-slate-800 hover:bg-slate-900 text-white px-4 py-2 rounded-xl text-sm font-semibold transition-colors flex items-center gap-2 shadow-sm">
                ...
                <tbody>
                    ...
                    <tr class="bg-white border-b hover:bg-gray-50 transition-colors">
                        ...
                        <td class="px-6 py-4 text-right whitespace-nowrap flex justify-end gap-2 items-center">
                            <a href="{{ route('admin.users.edit', $user->id) }}" class="inline-flex items-center gap-1.5 px-3 py-1.5 text-xs font-medium text-slate-700 bg-white border border-slate-200 rounded-lg hover:bg-slate-50 hover:text-blue-600 transition-colors mr-2">
