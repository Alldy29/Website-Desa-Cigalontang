...
<div class="relative bg-gradient-to-br from-green-900 via-primary to-emerald-800 pt-16 pb-28 overflow-hidden">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
        <div class="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-white/20 text-white text-sm font-semibold tracking-widest uppercase mb-6 border border-white/30 backdrop-blur-md shadow-sm">
            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>
            Tentang Desa
        </div>
        <h1 class="text-3xl font-extrabold text-white tracking-tight sm:text-4xl md:text-5xl drop-shadow-lg">Profil Desa Cigalontang</h1>
        <p class="mt-4 text-base md:text-lg text-green-50 max-w-2xl mx-auto drop-shadow leading-relaxed">Mengenal lebih dekat sejarah, visi misi, letak geografis, demografi, dan struktur pemerintahan Desa Cigalontang.</p>
    </div>
</div>

<!-- Main Content Area -->
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 -mt-12 mb-12 relative z-20">
    <div class="bg-white rounded-2xl shadow-xl overflow-hidden" x-data="{ tab: 'sejarah' }">
        ...
        <!-- Sejarah Section -->
        <div x-show="tab === 'sejarah'" class="p-8 md:p-12">
            <div class="flex flex-col md:flex-row gap-12 items-center">
                ...
                <div class="md:w-1/2 w-full group relative">
                    ...
                    <div class="aspect-video w-full bg-gray-200 rounded-2xl overflow-hidden shadow-lg relative border border-gray-100">
                        ...
                        <div class="absolute inset-0 bg-gradient-to-t from-black/60 via-black/0 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500 flex items-end">
                            <p class="text-white font-medium p-6 drop-shadow-md">Pelestarian Kesenian Tradisional</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <!-- Visi Misi Section -->
        <div x-show="tab === 'visimisi'" class="p-8 md:p-12 bg-gray-50/50" style="display: none;">
                ...
                <div class="lg:col-span-7">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        @foreach($misiArray as $index => $misi)
                            @if(trim($misi) != '')
                            <div class="bg-white p-5 rounded-2xl shadow-sm border border-gray-100 flex gap-4 items-start hover:shadow-md hover:-translate-y-1 transition-all duration-300 group">
        ...
        <div x-show="tab === 'geografis'" class="p-8 md:p-12" style="display: none;">
            ...
            <!-- Demografi Section -->
            <div class="mt-16 bg-white rounded-3xl p-8 md:p-12 border border-gray-100 shadow-sm relative overflow-hidden">
                <!-- Header -->
        ...
        <div x-show="tab === 'peta'" class="p-8 md:p-12 bg-gray-50" style="display: none;">
            <div class="text-center mb-12">
        ...
        <div x-show="tab === 'aparatur'" class="p-8 md:p-12" style="display: none;">
            <div class="text-center mb-12">
            ...
            @php
               ...
               // Fallback untuk selain di atas
               $lainnya = $aparaturs->filter(function($a) {
                   $jab = strtolower($a->jabatan);
                   return $jab !== 'kepala desa' && $jab !== 'sekretaris desa' && !str_contains($jab, 'kaur') && !str_contains($jab, 'kasi');
               });
            @endphp
            ...
            <div class="max-w-6xl mx-auto space-y-16 mt-8">
                ...
                <div class="flex flex-col items-center gap-12">
                    ...
                    <div class="text-center group w-72 mx-auto">
                        <div class="w-56 h-56 mx-auto rounded-3xl bg-gray-100 mb-5 overflow-hidden shadow-md border-4 border-white group-hover:border-primary/40 transition-all group-hover:shadow-xl relative">
                            <img src="{{ $kades->foto_url ? (Storage::disk('public')->exists($kades->foto_url) ? Storage::url($kades->foto_url) : $kades->foto_url) : 'https://ui-avatars.com/api/?name=' . urlencode($kades->nama) . '&background=random&color=fff&size=256' }}" class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500">
                        </div>
                    ...
                    <div class="text-center group w-64 mx-auto relative">
                        ...
                        <div class="w-48 h-48 mx-auto rounded-3xl bg-gray-100 mb-4 overflow-hidden shadow-sm border-4 border-white group-hover:border-secondary/40 transition-all group-hover:shadow-lg relative">
                            <img src="{{ $sekdes->foto_url ? (Storage::disk('public')->exists($sekdes->foto_url) ? Storage::url($sekdes->foto_url) : $sekdes->foto_url) : 'https://ui-avatars.com/api/?name=' . urlencode($sekdes->nama) . '&background=random&color=fff&size=256' }}" class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500">
                        </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-8 bg-gray-50/50 p-8 rounded-3xl border border-gray-100">
                    ...
                    <div>
                        ...
                        <div class="flex justify-center gap-6 flex-wrap">
                            ...
                            <div class="text-center group w-44">
                                <div class="w-36 h-36 mx-auto rounded-2xl bg-white mb-3 overflow-hidden shadow-sm border-4 border-white group-hover:border-gray-300 transition-all group-hover:shadow-md relative">
                                    <img src="{{ $kaur->foto_url ? (Storage::disk('public')->exists($kaur->foto_url) ? Storage::url($kaur->foto_url) : $kaur->foto_url) : 'https://ui-avatars.com/api/?name=' . urlencode($kaur->nama) . '&background=random&color=fff&size=256' }}" class="w-full h-full object-cover group-hover:scale-110 transition-transform duration-500">
                                </div>
                    ...
                    <div>
                        ...
                        <div class="flex justify-center gap-6 flex-wrap">
                            ...
                            <div class="text-center group w-44">
                                <div class="w-36 h-36 mx-auto rounded-2xl bg-white mb-3 overflow-hidden shadow-sm border-4 border-white group-hover:border-gray-300 transition-all group-hover:shadow-md relative">
                                    <img src="{{ $kasi->foto_url ? (Storage::disk('public')->exists($kasi->foto_url) ? Storage::url($kasi->foto_url) : $kasi->foto_url) : 'https://ui-avatars.com/api/?name=' . urlencode($kasi->nama) . '&background=random&color=fff&size=256' }}" class="w-full h-full object-cover group-hover:scale-110 transition-transform duration-500">
                                </div>
                ...
                <!-- Lainnya Group (Kepala Dusun, dll) -->
                @if($lainnya->count() > 0)
                <div class="pt-8 border-t border-gray-100">
                    ...
                    <div class="flex justify-center gap-8 flex-wrap">
                        ...
                        <div class="text-center group w-44">
                            <div class="w-36 h-36 mx-auto rounded-2xl bg-white mb-3 overflow-hidden shadow-sm border-4 border-white group-hover:border-gray-300 transition-all group-hover:shadow-md relative">
                                <img src="{{ $lain->foto_url ? (Storage::disk('public')->exists($lain->foto_url) ? Storage::url($lain->foto_url) : $lain->foto_url) : 'https://ui-avatars.com/api/?name=' . urlencode($lain->nama) . '&background=random&color=fff&size=256' }}" class="w-full h-full object-cover group-hover:scale-110 transition-transform duration-500">
                            </div>
                            <h4 class="text-sm font-bold text-gray-900 leading-tight mb-1">{{ $lain->nama }}</h4>
                            <p class="text-[11px] text-gray-500 font-medium leading-tight">{{ $lain->jabatan }}</p>
                        </div>
                        @endforeach
                    </div>
                </div>
